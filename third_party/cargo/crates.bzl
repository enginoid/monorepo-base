...
def raze_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        build_file = Label("//third_party/cargo/remote:clap-2.33.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//third_party/cargo/remote:hermit-abi-0.1.11.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//third_party/cargo/remote:libc-0.2.69.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//third_party/cargo/remote:unicode-width-0.1.7.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//third_party/cargo/remote:vec_map-0.8.1.BUILD"),
    )
